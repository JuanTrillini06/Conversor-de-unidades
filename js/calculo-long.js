...
function actualizarResultado() { 
    ...
    let notificar = (convertidoLong != 0 || NaN) ? Toastify({ text:"Calculo realizado", duration: 3000,style:{background:"linear-gradient(to right, #42E700, #7DDA58)"},}).showToast() : Toastify({ text:"Calculo erroneo", duration: 3000, style:{background:"linear-gradient(to right, #E4080A, #E56C6E)",}}).showToast()
}
